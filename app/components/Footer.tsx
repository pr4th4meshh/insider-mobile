...
const Footer = () => {
  return (
    <div className="bg-[#000000] h-[430px]">
      <div className="  flex xxs:px-[10px] text-[16px] font-light text-gray-300 ">
        <div className="flex flex-1 flex-col xxs:px-[10px] relative top-[40px]  ">
        <Image
            src={logo}
            alt="logo"
          />
